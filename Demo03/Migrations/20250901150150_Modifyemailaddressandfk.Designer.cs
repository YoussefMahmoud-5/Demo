...
namespace Demo03.Migrations
{
    ...
    [Migration("20250901150150_Modifyemailaddressandfk")]
    partial class Modifyemailaddressandfk
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Demo03.Models.Employee", b =>
                {
                    ...
                    b.Property<int>("FKDepartmentDeptId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Demo03.Models.Employee", b =>
                {
                    b.HasOne("Demo03.Models.Department", "EmployeeDepartment")
                        .WithMany("Employees")
                        .HasForeignKey("FKDepartmentDeptId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
